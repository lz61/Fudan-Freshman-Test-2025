# Fudan-Freshman-Test-2025

## 前言

做得太折磨了,特来助新生一臂之力.

不好意思,底下的代码还有点烂,笔者仍在整理中......
...
注: 去年的自动化答题脚本并不好用,推荐使用"每题搜索法".

## 新生教育入学测试参考答案

2024 年复旦大学研究生入学教育测试参考答案
...
155.对于学位论文盲审不存在异议，但 2 份盲审结论均为“论文质量一般”者，以下说法正确的是：______（多选）
...
任何机构和组织一般不会用（hotmail、gmail、163、aol、yahoo）.com等常用个人邮件系统的账号作为服务邮箱。
